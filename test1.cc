...
int main(int argc, char *argv[])
{
    ...
    Simulator::Schedule(Seconds(0.00),
                        []()
                        {
                            ...
                            for (int i = PEOPLE_SHINOVAC + PEOPLE_ASTRA + SOLIDER_ASTRA + SOLIDER_Pfizer + PEOPLE_MODERNA + PEOPLE_SIAS + PEOPLE_ASPRI + PEOPLE_INFECT + 1; i < PEOPLE_SHINOVAC + PEOPLE_ASTRA + SOLIDER_ASTRA + SOLIDER_Pfizer + PEOPLE_MODERNA + PEOPLE_SIAS + PEOPLE_ASPRI + PEOPLE_INFECT + PEOPLE_UNVAC; i++)
                            {
                                pAnim->UpdateNodeSize(i, NodeSide, NodeSide);
